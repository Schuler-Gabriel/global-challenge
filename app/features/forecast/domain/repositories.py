...
from .entities import Forecast, ModelMetrics, WeatherData
...
class ModelRepository(ABC):
    ...
    async def save_model(
        self, model: Any, model_version: str, metadata: Dict[str, Any]
    ) -> bool:
        """
...
class CacheRepository(ABC):
    ...
    async def set_forecast_cache(
        self, forecast: Forecast, ttl_seconds: int = 3600
    ) -> bool:
        """
