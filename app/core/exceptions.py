...
class ConfigurationError(BaseApplicationException):
    ...
    def __init__(self, message: str, config_key: Optional[str] = None):
        ...
        super().__init__(message=message, error_code="CONFIG_ERROR", context=context)
...
class ModelPredictionError(ModelError):
    ...
    def __init__(
        self, message: str = "Model prediction failed", context: Optional[Dict] = None
    ):
        super().__init__(
            message=message, error_code="MODEL_PREDICTION_ERROR", context=context or {}
        )
...
class InvalidInputDataError(ModelError):
    ...
    def __init__(self, message: str, input_data: Optional[Any] = None):
        ...
        super().__init__(
            message=message, error_code="INVALID_INPUT_DATA", context=context
        )
...
class APIConnectionError(ExternalAPIError):
    ...
    def __init__(
        self, api_name: str, url: str, original_exception: Optional[Exception] = None
    ):
        super().__init__(
...
class DataValidationError(DataProcessingError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, error_code="DATA_VALIDATION_ERROR", context=context
        )
...
class AlertGenerationError(AlertSystemError):
    ...
    def __init__(
        self, message: str = "Failed to generate alert", context: Optional[Dict] = None
    ):
        super().__init__(
            message=message, error_code="ALERT_GENERATION_ERROR", context=context or {}
        )
...
class CacheConnectionError(CacheError):
    ...
    def __init__(
        self, cache_type: str = "cache", original_exception: Optional[Exception] = None
    ):
        super().__init__(
...
def get_error_details(exception: Exception) -> Dict[str, Any]:
    ...
    if isinstance(exception, BaseApplicationException):
        error_details.update(
            {"error_code": exception.error_code, "context": exception.context}
        )
